define(function () {
  ...
  function numCells(len) {
    return Math.floor(len / CELL_SIZE);
  }

  var gameGrid = makeGrid(numCells(lifeCanvas.width), numCells(lifeCanvas.height));
